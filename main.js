    ...
    const studentInfo = await inquirer.prompt([
        {
            ...
            validate: (value) => value.trim() !== "" || chalk.bgRed.white("Please enter a valid name."),
        },
        {
            type: "number",
            name: "Age",
        ...
        },
        {
            type: "input",
            name: "university",
            message: chalk.bgRed.white(`Could You Please Give Me The University's Name : `),
            validate: (value) => value.trim() !== "" ||
                chalk.bgRed.white("Please enter a valid university name."),
        },
        {
            type: "input",
            name: "batch",
